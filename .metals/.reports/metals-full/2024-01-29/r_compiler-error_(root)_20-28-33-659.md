  ...
  private def publicRoutes(itemService: ItemService): HttpRoutes[IO] =
    HttpRoutes.of {
      ...
      case GET -> Root / "latest" / IntVar(pageNumber) => {
        itemService.getLatestItems(pageNumber * singlePageItemCount, singlePageItemCount).flatMap {
          Ok(_)
        }
      }

      case GET -> Root / ItemCategory(category) / IntVar(pageNumber) => {
        itemService.getCategoryItems(category, pageNumber * singlePageItemCount, singlePageItemCount).flatMap {
          Ok(_)
        }
      }
...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:107)
	...
	dotty.tools.dotc.core.TypeComparer$.lub(TypeComparer.scala:2973)
	dotty.tools.dotc.core.Types$Type.$bar(Types.scala:1173)
	dotty.tools.dotc.core.ConstraintHandling.op$proxy2$1(ConstraintHandling.scala:314)
	dotty.tools.dotc.core.ConstraintHandling.addOneBound(ConstraintHandling.scala:314)
	dotty.tools.dotc.core.ConstraintHandling.addOneBound$(ConstraintHandling.scala:29)
	dotty.tools.dotc.core.TypeComparer.addOneBound(TypeComparer.scala:30)
	dotty.tools.dotc.core.ConstraintHandling.addBoundTransitively(ConstraintHandling.scala:370)
	dotty.tools.dotc.core.ConstraintHandling.addBoundTransitively$(ConstraintHandling.scala:29)
	dotty.tools.dotc.core.TypeComparer.addBoundTransitively(TypeComparer.scala:30)
	dotty.tools.dotc.core.ConstraintHandling.addConstraint(ConstraintHandling.scala:860)
	dotty.tools.dotc.core.ConstraintHandling.addConstraint$(ConstraintHandling.scala:29)
	dotty.tools.dotc.core.TypeComparer.addConstraint(TypeComparer.scala:30)
	dotty.tools.dotc.core.TypeComparer.compareTypeParamRef$2(TypeComparer.scala:617)
	dotty.tools.dotc.core.TypeComparer.thirdTry$1(TypeComparer.scala:627)
	dotty.tools.dotc.core.TypeComparer.secondTry$1(TypeComparer.scala:422)
	dotty.tools.dotc.core.TypeComparer.firstTry$1(TypeComparer.scala:341)
	dotty.tools.dotc.core.TypeComparer.recur(TypeComparer.scala:1469)
	dotty.tools.dotc.core.TypeComparer.secondTry$1(TypeComparer.scala:460)
	dotty.tools.dotc.core.TypeComparer.firstTry$1(TypeComparer.scala:341)
	dotty.tools.dotc.core.TypeComparer.recur(TypeComparer.scala:1469)
	dotty.tools.dotc.core.TypeComparer.firstTry$1(TypeComparer.scala:343)
	dotty.tools.dotc.core.TypeComparer.recur(TypeComparer.scala:1469)
	...
	dotty.tools.dotc.core.TypeComparer.isSameType(TypeComparer.scala:2177)
	dotty.tools.dotc.core.TypeComparer.isSubArg$1(TypeComparer.scala:1698)
	dotty.tools.dotc.core.TypeComparer.recurArgs$1(TypeComparer.scala:1700)
	dotty.tools.dotc.core.TypeComparer.isSubArgs(TypeComparer.scala:1703)
	dotty.tools.dotc.core.TypeComparer.loop$1(TypeComparer.scala:1254)
	dotty.tools.dotc.core.TypeComparer.isMatchingApply$1(TypeComparer.scala:1268)
	dotty.tools.dotc.core.TypeComparer.compareAppliedType2$1(TypeComparer.scala:1338)
	dotty.tools.dotc.core.TypeComparer.thirdTry$1(TypeComparer.scala:623)
	dotty.tools.dotc.core.TypeComparer.secondTry$1(TypeComparer.scala:550)
	...
	dotty.tools.dotc.core.TypeComparer$.necessarySubType(TypeComparer.scala:2943)
	dotty.tools.dotc.typer.ProtoTypes$Compatibility.necessarilyCompatible(ProtoTypes.scala:49)
	dotty.tools.dotc.typer.ProtoTypes$Compatibility.necessarilyCompatible$(ProtoTypes.scala:28)
	dotty.tools.dotc.typer.Typer.necessarilyCompatible(Typer.scala:116)
	dotty.tools.dotc.typer.ProtoTypes$Compatibility.constrainResult(ProtoTypes.scala:99)
	dotty.tools.dotc.typer.ProtoTypes$Compatibility.constrainResult$(ProtoTypes.scala:28)
	dotty.tools.dotc.typer.Typer.constrainResult(Typer.scala:116)
	dotty.tools.dotc.typer.ProtoTypes$Compatibility.constrainResult(ProtoTypes.scala:119)
	dotty.tools.dotc.typer.ProtoTypes$Compatibility.constrainResult$(ProtoTypes.scala:28)
	dotty.tools.dotc.typer.Typer.constrainResult(Typer.scala:116)
	dotty.tools.dotc.typer.Typer.adaptNoArgs$1(Typer.scala:4036)
