...
### java.lang.AssertionError: assertion failed: denotation trait GenConcurrent invalid in run 1. ValidFor: Period(1..5, run = 3)
...
object ItemRoutes {
  ...
  import org.mxr.shop.service.ItemServic
